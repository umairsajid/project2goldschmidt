...
public class ProcessManager {
    ...
    public void exitProcesses(int probabilityExit) {
        System.out.println(probabilityExit+"% chance for processes to exit.");
        Random processExitRNG = new Random();
        for (int i = 0; i < processes.size(); i++) {
            if (probabilityExit >= processExitRNG.nextInt(100)) {
